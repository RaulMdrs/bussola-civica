...
|---|---|---:|---|
| <span class="eixo-par">Coesão com o próprio partido</span> | <span class="escopo">Todas as votações abertas</span> | [<span class="valor">93,5%</span>](evidencia/coesao-partidaria-unico/) | <span class="n-detalhe">107 <span>votações computáveis</span></span><span class="n-detalhe">117 <span>votações no exercício</span></span> |
{: .t-eixos}
...
<a class="fonte" href="https://legis.senado.leg.br/dadosabertos/votacao?codigoSessaoVotacao=6951">Ver votação na fonte oficial</a>
</div>
</blockquote>
...
<a class="fonte" href="https://legis.senado.leg.br/dadosabertos/votacao?codigoSessaoVotacao=6952">Ver votação na fonte oficial</a>
</div>
</blockquote>
...
- [Coesão com o próprio partido, todas as votações abertas](evidencia/coesao-partidaria-unico/) — 107 votações,
  coincidências inclusive

## O que disse em plenário

São **510 discursos** coletados no período, todos substantivos.
...
|---|---:|---:|
| [2026](discursos/2026/) | <span class="n"><b>69</b></span> | 69 |
