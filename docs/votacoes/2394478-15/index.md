...
| Identificador oficial | `2394478-15` |
| Placar | Sim: 312; total: 312. |
| Resultado | aprovada |
| Matéria | REQ 3458/2023 |
| Natureza | requerimento — urgência, pauta, adiamento |
| Orientação do Governo | **sim** |
{: .t-docs}

<a class="fonte" href="https://dadosabertos.camara.leg.br/api/v2/votacoes/2394478-15">Ver o registro na fonte oficial</a>

### A matéria

> Requer aprovação de Moção de Repúdio contra os atos de guerra promovidos pelo grupo Hamas, no dia de hoje, 7 de outubro, ao Estado de Israel.
