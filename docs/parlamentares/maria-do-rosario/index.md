...
|---|---|---:|---|
| <span class="eixo-gov">Alinhamento com o governo federal</span> | <span class="escopo">Mérito</span> | [<span class="valor">95,3%</span>](evidencia/alinhamento-governo-merito/) | <span class="n-detalhe">342 <span>votações computáveis</span></span><span class="n-detalhe">571 <span>votações no exercício</span></span> |
...
| <span class="eixo-par">Coesão com o próprio partido</span> | <span class="escopo">Mérito</span> | [<span class="valor">97,0%</span>](evidencia/coesao-partidaria-merito/) | <span class="n-detalhe">427 <span>votações computáveis</span></span><span class="n-detalhe">571 <span>votações no exercício</span></span> |
...
- [Alinhamento com o governo federal, mérito](evidencia/alinhamento-governo-merito/) — 342 votações
- [Alinhamento com o governo federal, procedimental](evidencia/alinhamento-governo-procedimental/) — 285 votações
- [Coesão com o próprio partido, mérito](evidencia/coesao-partidaria-merito/) — 427 votações
- [Coesão com o próprio partido, procedimental](evidencia/coesao-partidaria-procedimental/) — 373 votações

## O que disse em plenário

São **326 discursos** coletados no período, dos quais **292 substantivos** — os outros 34 são
